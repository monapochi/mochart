...
var HUD_DIRTY = 2;
var AT_RIGHT_EDGE = 8;
var PUBLIC_RUNTIME_VERSION = "20260310d";
...
function allocIndSab() {
  return new SharedArrayBuffer(INDSAB_HDR_BYTES + FRAME_MAX_BARS * MAX_RENDER_CMDS * 4);
}
...
function createChart(container, options) {
  ...
  const dataWorker = resolvedOptions.dataWorker ?? new Worker(resolvedOptions.dataWorkerUrl ? new URL(resolvedOptions.dataWorkerUrl, import.meta.url) : new URL(`./demo/dataWorker.js?v=${PUBLIC_RUNTIME_VERSION}`, import.meta.url), { type: "module" });
  const renderWorker = resolvedOptions.sharedRenderWorker ?? new Worker(resolvedOptions.renderWorkerUrl ? new URL(resolvedOptions.renderWorkerUrl, import.meta.url) : new URL(`./demo/renderWorker.js?v=${PUBLIC_RUNTIME_VERSION}`, import.meta.url), { type: "module" });
  ...
  postWorkerMessage(renderWorker, {
    type: "init",
    buildVersion: PUBLIC_RUNTIME_VERSION,
    descriptor: {
      slotId: managerSlotId,
      ctrl: ctrlBuf,
      frameCtrl,
...
//# debugId=B02F31CD4578EA0064756E2164756E21
