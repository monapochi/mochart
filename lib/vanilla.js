...
function createChart(container, options) {
  const core = new ChartCore(container, options);
  const disposeUiBindings = attachChartUiBindings(core, container, options);
  core.registerLifecycleDisposer(disposeUiBindings);
  const interaction = new ChartInteractionBindings(core, container, options);
...
if (typeof globalThis !== "undefined") {
  const host = globalThis;
  host.Mochart = exports_src;
}
var vanilla_default = exports_src;
export {
...
//# debugId=1B4F5038E663D20B64756E2164756E21
